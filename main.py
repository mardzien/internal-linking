...
def create_inlinks_report(nlp_model, source_url_list, database_df, input_class):
    ...
    for url_idx, url in enumerate(urls):
        ...
        for d_url in destination_url_list:
            ...
            # TODO: LOCK?
            # lock tutaj nie ma sensu
            # TODO: Jak to działa? Wygląda na filtrowanie
            # To jest wybór warunkowy z kolumny "Lemma", gdzie wartość jest równa URLowi docelowemu
            ...
            # myślałem o tym wcześniej, ale nie wiem jak sprawdzić ile miejsca w pamięci zajmuje matcher.
            # przy dużej ilości URLi może to być kłopotliwe.
            ...
            if len(found_matches) != 0:
                ...
                # Match ID jest potrzebny tylko do tuple unpackingu
